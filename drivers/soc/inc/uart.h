...
//interrrupt identification definition  4bit
#define UART_ITR_MS     0   //Modem Status
#define UART_ITR_TD     2   //transmitter holding register empty
#define UART_ITR_RT     12  //reciever character timout
#define UART_ITR_RD     4   //recieved data avalible
#define UART_ITR_RL     6   //receiver  line status

#define MAX_FIFO_THR    56
...
extern uart_rx_buffer_t uart_rx_data[MAX_BUFFER_SIZE];
