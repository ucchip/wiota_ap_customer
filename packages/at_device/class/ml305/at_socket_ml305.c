...
#define ML305_MODULE_SEND_MAX_SIZE 1000
...
#define ML305_EVNET_CLOSE_OK (1L << 3)
...
static int ml305_socket_close(struct at_socket *socket)
{
    ...
    event = SET_EVENT(device_socket, ML305_EVNET_CLOSE_OK);
...
static void urc_close_func(struct at_client *client, const char *data, rt_size_t size)
{
    ...
    {
        ml305_socket_event_send(device, SET_EVENT(device_socket, ML305_EVNET_CLOSE_OK));
    }
...
static const struct at_socket_ops ml305_socket_ops =
{
