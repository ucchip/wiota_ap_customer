...
/* Init ptpClock with run time values (initialization constants are in ptpv2_constants.h)*/
...
//Best Master Clock algorithm确定精度最高的时钟，确定为全局主时钟（grandmaster clock）
